...
try:
    from .enhanced_trending_oi_pa_analysis import EnhancedTrendingOIPAAnalysis as EnhancedTrendingOIWithPAAnalysis
except ImportError:
    from enhanced_trending_oi_pa_analysis import EnhancedTrendingOIPAAnalysis as EnhancedTrendingOIWithPAAnalysis
...
class Enhanced18RegimeDetectorV2:
    ...
    def _initialize_indicator_systems(self):
        ...
        try:
            ...
            self.greek_sentiment = EnhancedGreekSentimentAnalysis(self.config.get('greek_sentiment', {}))
