...
try:
    ...
    try:
        ...
        import sys
        sys.path.append(str(Path(__file__).parent.parent))
        from comprehensive_modules.comprehensive_triple_straddle_engine import StraddleAnalysisEngine
    except ImportError:
        # Create a stub if not available
        logger.warning("StraddleAnalysisEngine not available, using stub")
...
class EnhancedMarketRegimeEngine:
    ...
    def __init__(self):
        ...
        self.comprehensive_engine = StraddleAnalysisEngine()
