"""
ML Indicator Strategy Data Models
Supports technical analysis with ML-based signal generation
"""
...
class MLIndicatorPortfolioModel(BaseModel):
    """Portfolio configuration for ML Indicator strategies"""
...
@dataclass
class MLSignal:
    """Trading signal generated by ML model"""
...
@dataclass  
class MLTrade:
    """Executed trade based on ML signal"""
    signal: MLSignal
    entry_price: float
    position_size: float
    stop_loss: float
...
MLPortfolioConfig = MLIndicatorPortfolioModel
MLIndicatorConfig = IndicatorConfig


class MLIndicatorStrategyModel(BaseModel):
    """Complete ML Indicator strategy configuration"""
