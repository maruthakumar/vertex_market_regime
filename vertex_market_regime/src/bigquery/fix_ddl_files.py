#!/usr/bin/env python3
"""
Fix corrupted DDL files and ensure proper Phase 2 feature counts
"""
...
def fix_c1_features():
    """Fix Component 1 DDL file"""
    ddl_path = Path(__file__).parent / "ddl" / "c1_features.sql"
    
    content = """-- Component 1: Triple Straddle Features + Momentum Enhancement (Phase 2)
...
OPTIONS(
  ...
  labels=[("component", "c1"), ("feature_count", "150"), ("version", "2.0"), ("phase", "momentum_enhanced")]
    ...
    print("✅ Fixed c1_features.sql with exactly 150 features")


def main():
    """Fix all corrupted DDL files"""
    print("🔧 Fixing corrupted DDL files...")
    fix_c1_features()
    print("✅ DDL files fixed")
